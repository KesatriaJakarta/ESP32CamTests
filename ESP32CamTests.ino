...
void setup() {
  ...
  Serial.println("                                    ");
  Serial.println("--------------------------");
  Serial.println("ESP32-CAM Video Recorder");
  Serial.println("--------------------------");
  ...
  if (init_wifi()) { // Connected to WiFi
    ...
    init_time();
    time(&now);
    setenv("TZ", "EET-7EEST,M3.5.0/01,M10.5.0/02", 1);
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//just takes a picture and discards it
...
<body>
<h1>ESP32-CAM Video Recorder</h1><br>
...
<body>
<h1>ESP32-CAM Video Recorder<br><font color="red">%s</font></h1><br>
 <h2>Message is <font color="red">%s</font></h2><br>
 Recording = %d (1 is active)<br>
